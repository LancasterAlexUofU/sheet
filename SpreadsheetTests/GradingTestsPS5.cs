...
public class SpreadsheetTest
{
    ...
    [TestCategory("13")]
    [ExpectedException(typeof(InvalidNameException))]
    public void SetContentOfCells_InvalidCellNameForFormula_Throws()
    {
        Spreadsheet s = new();
    ...
    public void SetContentsOfCell_SettingIndependentCellToFormula_ReturnsOnlyThatCell()
    {
        ...
        s.SetContentsOfCell("A1", "17.2");
        s.SetContentsOfCell("B1", "hello");
        var changed = s.SetContentsOfCell("C1", "=" + new Formula("5"));
    ...
    public void SetContentsOfCell_TwoHundredLongChain_EachTimeReturnsRestOfChain()
    {
        ...
        for (int i = 1; i < 200; i++)
        {
            ...
            var changed = s.SetContentsOfCell(currentCell, "=" + new Formula("A" + (i + 1)));
    ...
    public void SetContentsOfCell_LongChainAddCircularInMiddle_Throws()
    {
        ...
        for (int i = 1; i < 200; i++)
        {
            ...
            s.SetContentsOfCell(currentCell, "=" + new Formula(nextCell));
        }
    ...
    {
        SetContentsOfCell_1000RandomCells_MatchesPrecomputedSizeValue(47, 805); // Modified from 2514 to 805
    }
    ...
    {
        SetContentsOfCell_1000RandomCells_MatchesPrecomputedSizeValue(48, 830); // Modified from 2519 to 830
    }
    ...
    {
        SetContentsOfCell_1000RandomCells_MatchesPrecomputedSizeValue(49, 821); // Modified from 2502 to 821
    }
    ...
    {
        SetContentsOfCell_1000RandomCells_MatchesPrecomputedSizeValue(50, 835); // Modified from 2515 to 835
    }
            ...
            try
            {
                ...
                switch (rand.Next(3))
                {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        s.SetContentsOfCell(cellName, "=" + new Formula(GenerateRandomFormula(rand)));
                        break;
                }
            }
            catch (CircularException)
